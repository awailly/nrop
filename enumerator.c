 ...
 */
static bool enumerate_empty(enumerator_t *enumerator __attribute__((unused)), ...)
{
	return FALSE;
}
...
enumerator_t* enumerator_create_empty()
{
	...
	this->destroy = (void (*)(enumerator_t *))free;
	return this;
}
							   ...
							   char **absolute, struct stat *st)
{
	...
	if (absolute || st)
	{
		...
		{
			logging("buffer too small to enumerate file '%s'",
				 entry->d_name);
			return FALSE;
		}
		if (absolute)
		...
		if (st)
		{
			...
			{
				logging("stat() on '%s' failed: %s", this->full,
					 strerror(errno));
				return FALSE;
			}
		}
...
enumerator_t* enumerator_create_directory(char *path)
{
	...
	this->public.enumerate = (bool (*)(enumerator_t *this, ...)) enumerate_dir_enum;
	this->public.destroy = (void (*)(enumerator_t *this)) destroy_dir_enum;
	...
	if (len < 0 || (size_t)len >= sizeof(this->full)-1)
	{
		logging("path string '%s' too long", path);
		free(this);
		return NULL;
	}
	...
	if (this->dir == NULL)
	{
		logging("opening directory '%s' failed: %s", path, strerror(errno));
		free(this);
		return NULL;
	}
	return &this->public;
...
enumerator_t* enumerator_create_token(char *string, char *sep, char *trim)
{
	...
	enumerator->public.enumerate = (bool (*)(enumerator_t *this, ...))enumerate_token_enum;
	enumerator->public.destroy = (void (*)(enumerator_t *this))destroy_token_enum;
					...
					void *data, void (*destroy_data)(void *data))
{
	...
	enumerator->public.enumerate = (bool (*)(enumerator_t *, ...))enumerate_nested;
	enumerator->public.destroy = (void (*)(enumerator_t *))destroy_nested;
	enumerator->outer = outer;
	enumerator->inner = NULL;
	enumerator->create_inner = (enumerator_t *(*)(void *, void *)) inner_constructor;
									   ...
									   void *data, void (*destructor)(void *data))
{
	...
	this->public.enumerate = (bool (*)(enumerator_t *, ...)) enumerate_filter;
	this->public.destroy = (void (*)(enumerator_t *)) destroy_filter;
										...
										void (*cleanup)(void *data), void *data)
{
	...
	this->public.enumerate = (bool (*)(enumerator_t *, ...)) enumerate_cleaner;
	this->public.destroy = (void (*)(enumerator_t *)) destroy_cleaner;
...
enumerator_t *enumerator_create_single(void *item, void (*cleanup)(void *item))
{
	...
	this->public.enumerate = (bool (*)(enumerator_t *, ...))enumerate_single;
	this->public.destroy = (void (*)(enumerator_t *))destroy_single;
	this->item = item;
	this->cleanup = cleanup;
	this->done = FALSE;
