/*
 * Implementation of restore insertion plugin
 */

#include "plugin_restore.h"

#define BUFLEN  1000

typedef struct private_plugin_restore_t private_plugin_restore_t;

struct private_plugin_restore_t
{
    plugin_restore_t public;
    elf_t *code;

    status_t (*disassemble)(private_plugin_restore_t *, chunk_t);
    bool (*is_last_inst)(private_plugin_restore_t *, xed_decoded_inst_t);
    status_t (*pack)(private_plugin_restore_t *, section_t *);
    linked_list_t *(*find_rop_chains)(private_plugin_restore_t *, chunk_t, Elf64_Addr);
    status_t (*reverse_disass_ret)(private_plugin_restore_t *, chunk_t, Elf64_Addr, xed_decoded_inst_t, uint64_t, linked_list_t*);
};

static status_t disassemble(private_plugin_restore_t *this, chunk_t function_chunk)
{
...
static bool is_last_inst(private_plugin_restore_t *this, xed_decoded_inst_t xedd)
{
    return (
...
static status_t reverse_disass_ret(private_plugin_restore_t *this, chunk_t chunk, Elf64_Addr addr, xed_decoded_inst_t xedd, uint64_t ret_byte, linked_list_t *inst_list)
{
    xed_error_enum_t xed_error;
...
static linked_list_t* find_rop_chains(private_plugin_restore_t *this, chunk_t function_chunk, Elf64_Addr addr)
{
    xed_error_enum_t xed_error;
    xed_bool_t long_mode = 1;
    xed_decoded_inst_t xedd;
...
static status_t pack(private_plugin_restore_t *this, section_t *section)
{
    chunk_t chunk;
    Elf64_Addr addr;
    linked_list_t *inst_list;
...
static status_t apply(private_plugin_restore_t *this)
{
...
static void destroy(private_plugin_restore_t *this)
{
    free(this);
    this = NULL;
}
...
{
    private_plugin_restore_t *this = malloc_thing(private_plugin_restore_t);
    ...
    this->disassemble = (status_t (*)(private_plugin_restore_t *, chunk_t)) disassemble;
    this->is_last_inst = (bool (*)(private_plugin_restore_t *, xed_decoded_inst_t)) is_last_inst;
    this->pack = (status_t (*)(private_plugin_restore_t *, section_t *)) pack;
    this->find_rop_chains = (linked_list_t *(*)(private_plugin_restore_t *, chunk_t, Elf64_Addr)) find_rop_chains;
    this->reverse_disass_ret = (status_t (*)(private_plugin_restore_t *, chunk_t, Elf64_Addr, xed_decoded_inst_t, uint64_t, linked_list_t *)) reverse_disass_ret;
