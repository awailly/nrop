 ...
 */
chunk_t chunk_to_hex(chunk_t chunk, u_char *buf, bool uppercase);
 ...
 */
chunk_t chunk_from_hex(chunk_t hex, u_char *buf);
 ...
 * @return				chunk of encoded data
 */
chunk_t chunk_to_base64(chunk_t chunk, u_char *buf);
 ...
 * @return				converted data
 */
chunk_t chunk_from_base64(chunk_t base64, u_char *buf);
...
/**
 * Allocate a chunk on the heap with 0
 */
#define chunk_calloc(bytes) chunk_create(calloc(bytes, 1), bytes)
